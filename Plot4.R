## This is a script to create Plot 4
...
globalActivePower <- as.numeric(dataToReview$Global_active_power)
globalReactivePower <- as.numeric(dataToReview$Global_reactive_power)
voltage <- as.numeric(dataToReview$Voltage)
